...
import { DatallesTorneoComponent } from './datalles-torneo.component';
...
describe('DatallesTorneoComponent', () => {
  let component: DatallesTorneoComponent;
  let fixture: ComponentFixture<DatallesTorneoComponent>;
  let httpMock: HttpTestingController;
  let locationSpy: jasmine.SpyObj<Location>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [DatallesTorneoComponent],
    ...
    fixture = TestBed.createComponent(DatallesTorneoComponent);
