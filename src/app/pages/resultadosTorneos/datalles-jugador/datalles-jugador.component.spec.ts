...
import { DatallesJugadorComponent } from './datalles-jugador.component';
import { HttpClientTestingModule, HttpTestingController } from '@angular/common/http/testing';
import { ActivatedRoute } from '@angular/router';
import { Location } from '@angular/common';
import { environment } from 'src/environments/environment';

describe('DatallesJugadorComponent', () => {
  let component: DatallesJugadorComponent;
  let fixture: ComponentFixture<DatallesJugadorComponent>;
  let httpMock: HttpTestingController;
  let locationSpy: jasmine.SpyObj<Location>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [DatallesJugadorComponent],
    ...
    fixture = TestBed.createComponent(DatallesJugadorComponent);
